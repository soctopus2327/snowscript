            ...
            <div className="p-8 md:p-12">
              ...
              <CardContent className="p-0 pt-6">
                <p className="text-base text-muted-foreground">
                  Google Developer Groups (GDG) are local communities of
                  developers who are interested in resources and technology from
                  Google. Each GDG is a hub of innovation and learning, where
                  developers can connect, share ideas, and collaborate on
                  projects. Join us to be a part of a vibrant global network.
                </p>
        ...
        <div className="container mx-auto space-y-12 px-4 md:px-6">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-2 text-muted-foreground">
                Pick an issue, make a pull request, and start your coding journey.
              </p>
            </div>
          </div>
        </div>
