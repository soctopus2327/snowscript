...
export const projectDomains: ProjectDomain[] = [
  ...
  },
  {
    ...
    projects: [
      ...
      { name: 'OpenFlash', description: 'OpenFlash is a frontend-only learning tool built with Vanilla JavaScript.', contributeUrl: 'https://github.com/GDG-IGDTUW/Web-Dev-1/tree/main/OpenFlash' },
      { name: 'Smart Readability Dashboard', description: 'Smart Readability Dashboard is a simple, browser-based web app built using only HTML, CSS, and JavaScript that helps users understand how easy or difficult their text is to read. ', contributeUrl: 'https://github.com/GDG-IGDTUW/Web-Dev-1/tree/main/Smart-Readability-Dashboard' },
